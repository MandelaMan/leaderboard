...
export class Dashboard extends Component {
  ...
  leads_by_country = [
    { country: "Kenya", no_of_leads: 89 },
    { country: "Uganda", no_of_leads: 7 },
    { country: "Tanzania", no_of_leads: 3 },
    { country: "United Kingdom", no_of_leads: 2466 },
    { country: "United Arab Emirates", no_of_leads: 45 },
    { country: "Zambia", no_of_leads: 2 },
    { country: "China", no_of_leads: 2899 },
  ];

  leads = [
    {
      lead_no: "AGG-001YUTR",
      applicant: "Damaris Kizangila",
      country_of_origin: "Kenya",
      age: 55,
      plan_selected: "Major Medical",
      premium: 3500,
      coverage: "Worldwide",
    },
    {
          ...
          <div className="col-12 mb-3">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Leads distribution by country</h4>
                <div className="row">
                        ...
                        <tbody>
                          {this.leads_by_country.map((l, i) => (
                            <tr key={i}>
                              ...
                              <td>{l.country}</td>
                              <td className="text-right">{l.no_of_leads}</td>
                    ...
                    <tbody>
                      {this.leads.map((l, i) => (
                        <tr key={i}>
                          ...
                          <td>{l.age}</td>
                          <td>{l.coverage}</td>
                          <td>{l.country_of_origin}</td>
                          <td>{l.plan_selected}</td>
                          <td>${l.premium}</td>
                          <td>
